...
sysmetrics[]={
	...
	SM_CXFIXEDFRAME,TEXT("SM_CXFIXEDFRAME"),TEXT("Dialog windwow frame width"),

	SM_CYFIXEDFRAME,TEXT("SM_CYFIXEDFRAME"),TEXT("Dialog windwow frame HEIGHT"),
	...
	SM_CXICON,		TEXT("SM_YHICON"),TEXT("Icon height"),
	...
	SM_DEBUG,		TEXT("DEBUG"),TEXT("Debug version flag"),
	...
	SM_CXSIZEFRAME,	TEXT("SM_CXSIZEFRAME"),TEXT("Window sizeing frame width"),
	SM_CYSIZEFRAME,	TEXT("SM_CXSIZEFRAME"),TEXT("Window sizeing frame height"),
	...
	SM_CYEDGE,		TEXT("SM_CHEDGE"),TEXT("3D border height"),
	...
	SM_CYSMSIZE,	TEXT("SM_CYSMSIZE"),TEXT("SMALL caption buttong height"),
	SM_CXMENUSIZE,	TEXT("SM_CXMENUSIZE"),TEXT("Menu bar button width"),
	SM_CYMENUSIZE,	TEXT("SM_CYMENUSIZE"),	TEXT(" bar button height"),
	...
	SM_MOUSEWHEELPRESENT,	TEXT("SM_MOUSEWHEELPRESENT"),	TEXT("mouse wheel preesnt flag"),
	
	SM_XVIRTUALSCREEN,	TEXT("SM_XVIRTUALSCREEN"),	TEXT("Virtual screen x orign"),
	SM_YVIRTUALSCREEN,	TEXT("SM_YVIRTUALSCREEN"),	TEXT("Virtual screen y orign"),
